            ...
            <div className='container mx-auto font-rubik px-4 py-16 relative overflow-hidden'>
                <div className='grid grid-cols-1 lg:grid-cols-4 justify-center items-center place-items-center gap-8'>
                    ...
                    <div className='col-span-1 lg:col-span-3 text-justify'>
                        ...
                        <p className='mt-8 mb-8'>Minha jornada profissional começou na cidade de Salto do Lontra, no Paraná, onde cresci e desenvolvi interesse pelo área da tecnologia. Atualmente, estou residindo em Cascavel, também no Paraná, Pois estou cursando a faculdade de Engenharia de Software, na qual estou no 2º período.</p>
                        ...
                        <p className='mt-8 mb-8'>Estou comprometido em continuar aprimorando minhas habilidades e conhecimentos, tanto na faculdade como em projetos profissionais e pessoais. Acredito que a aprendizagem contínua é essencial para se manter atualizado no mundo da tecnologia em constante evolução.</p>
